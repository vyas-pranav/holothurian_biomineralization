...
"""Bifurcation angles on an ossicle.
...
What it does  : Renders ossicle_206 (loc_file_id[205]) as a translucent mesh with its
                base graph and a sphere at every split node coloured by the angle
                between the two outgoing edges (plasma, 60-120 deg).
...
for jj in range(205,206): #range(n_files):      print(ii, files[ii])
...
pl.camera.roll = 90.0
# pl.screenshot('205_front_angle_sc3.png', window_size=(10000,10000), transparent_background= True)
pl.show()
